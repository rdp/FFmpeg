...
const AVOption dshow_options[] = {
    ...
    { "dtv_tune_modulation", "specify a specific tune modulation (ex: 20 for QPSK) see msdn ModulationType", OFFSET(dtv_tune_modulation), AV_OPT_TYPE_INT, {.i64 = 0}, -1, BDA_MOD_MAX, DEC , "dtv_tune_modulation"},
    { "not_set", "Not Set", 0, AV_OPT_TYPE_CONST, {.i64=-1}, 0, 0, DEC, "dtv_tune_modulation" },
    { "not_def", "Not Defined", 0, AV_OPT_TYPE_CONST, {.i64=0}, 0, 0, DEC, "dtv_tune_modulation" },
    { "16qam", "16QAM", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, DEC, "dtv_tune_modulation" },
    { "32qam", "32QAM", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, DEC, "dtv_tune_modulation" },
    { "64qam", "64QAM", 0, AV_OPT_TYPE_CONST, {.i64=3}, 0, 0, DEC, "dtv_tune_modulation" },
    { "80qam", "80QAM", 0, AV_OPT_TYPE_CONST, {.i64=4}, 0, 0, DEC, "dtv_tune_modulation" },
    { "96qam", "96QAM", 0, AV_OPT_TYPE_CONST, {.i64=5}, 0, 0, DEC, "dtv_tune_modulation" },
    { "112qam", "112QAM", 0, AV_OPT_TYPE_CONST, {.i64=6}, 0, 0, DEC, "dtv_tune_modulation" },
    { "128qam", "128QAM", 0, AV_OPT_TYPE_CONST, {.i64=7}, 0, 0, DEC, "dtv_tune_modulation" },
    { "160qam", "160QAM", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, DEC, "dtv_tune_modulation" },
    { "192qam", "192QAM", 0, AV_OPT_TYPE_CONST, {.i64=9}, 0, 0, DEC, "dtv_tune_modulation" },
    { "224qam", "224QAM", 0, AV_OPT_TYPE_CONST, {.i64=10}, 0, 0, DEC, "dtv_tune_modulation" },
    { "256qam", "256QAM", 0, AV_OPT_TYPE_CONST, {.i64=11}, 0, 0, DEC, "dtv_tune_modulation" },
    { "320qam", "320QAM", 0, AV_OPT_TYPE_CONST, {.i64=12}, 0, 0, DEC, "dtv_tune_modulation" },
    { "384qam", "384QAM", 0, AV_OPT_TYPE_CONST, {.i64=13}, 0, 0, DEC, "dtv_tune_modulation" },
    { "448qam", "448QAM", 0, AV_OPT_TYPE_CONST, {.i64=14}, 0, 0, DEC, "dtv_tune_modulation" },
    { "512qam", "512QAM", 0, AV_OPT_TYPE_CONST, {.i64=15}, 0, 0, DEC, "dtv_tune_modulation" },
    { "640qam", "640QAM", 0, AV_OPT_TYPE_CONST, {.i64=16}, 0, 0, DEC, "dtv_tune_modulation" },
    { "768qam", "768QAM", 0, AV_OPT_TYPE_CONST, {.i64=17}, 0, 0, DEC, "dtv_tune_modulation" },
    { "896qam", "896QAM", 0, AV_OPT_TYPE_CONST, {.i64=18}, 0, 0, DEC, "dtv_tune_modulation" },
    { "1024qam", "1024QAM", 0, AV_OPT_TYPE_CONST, {.i64=19}, 0, 0, DEC, "dtv_tune_modulation" },
    { "qpsk", "QPSK", 0, AV_OPT_TYPE_CONST, {.i64=20}, 0, 0, DEC, "dtv_tune_modulation" },
    { "bpsk", "BPSK", 0, AV_OPT_TYPE_CONST, {.i64=21}, 0, 0, DEC, "dtv_tune_modulation" },
    { "oqpsk", "OQPSK", 0, AV_OPT_TYPE_CONST, {.i64=22}, 0, 0, DEC, "dtv_tune_modulation" },
    { "8vbs", "8VBS", 0, AV_OPT_TYPE_CONST, {.i64=23}, 0, 0, DEC, "dtv_tune_modulation" },
    { "16vbs", "16VBS", 0, AV_OPT_TYPE_CONST, {.i64=24}, 0, 0, DEC, "dtv_tune_modulation" },
    { "ana_ampl", "ANALOG AMPLITUDE", 0, AV_OPT_TYPE_CONST, {.i64=25}, 0, 0, DEC, "dtv_tune_modulation" },
    { "ana_freq", "ANALOG FREQUENCY", 0, AV_OPT_TYPE_CONST, {.i64=26}, 0, 0, DEC, "dtv_tune_modulation" },
    { "8psk", "8PSK", 0, AV_OPT_TYPE_CONST, {.i64=27}, 0, 0, DEC, "dtv_tune_modulation" },
    { "rf", "RF", 0, AV_OPT_TYPE_CONST, {.i64=28}, 0, 0, DEC, "dtv_tune_modulation" },
    { "16apsk", "16APSK", 0, AV_OPT_TYPE_CONST, {.i64=29}, 0, 0, DEC, "dtv_tune_modulation" },
    { "32apsk", "32APSK", 0, AV_OPT_TYPE_CONST, {.i64=30}, 0, 0, DEC, "dtv_tune_modulation" },
    { "nbc_qpsk", "NBC QPSK", 0, AV_OPT_TYPE_CONST, {.i64=31}, 0, 0, DEC, "dtv_tune_modulation" },
    { "nbc_8psk", "NBC 8PSK", 0, AV_OPT_TYPE_CONST, {.i64=32}, 0, 0, DEC, "dtv_tune_modulation" },
    { "directv", "DIRECTV", 0, AV_OPT_TYPE_CONST, {.i64=33}, 0, 0, DEC, "dtv_tune_modulation" },
    { "isdb_t", "ISDB T TMCC", 0, AV_OPT_TYPE_CONST, {.i64=34}, 0, 0, DEC, "dtv_tune_modulation" },
    { "isdb_s", "ISDB S TMCC", 0, AV_OPT_TYPE_CONST, {.i64=35}, 0, 0, DEC, "dtv_tune_modulation" }, 
    { "dtv_fec", "set Forward Error Correction (FEC) rate", OFFSET(dtv_fec), AV_OPT_TYPE_INT, {.i64 = 0}, -1, BDA_BCC_RATE_MAX, DEC , "dtv_fec"},
    { "not_set", "Not Set", 0, AV_OPT_TYPE_CONST, {.i64=-1}, 0, 0, DEC, "dtv_fec" },
    { "not_def", "Not Defined", 0, AV_OPT_TYPE_CONST, {.i64=0}, 0, 0, DEC, "dtv_fec" },
    { "1_2", "1/2", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, DEC, "dtv_fec" },
    { "2_3", "2/3", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, DEC, "dtv_fec" },
    { "3_4", "3/4", 0, AV_OPT_TYPE_CONST, {.i64=3}, 0, 0, DEC, "dtv_fec" },
    { "3_5", "3/5", 0, AV_OPT_TYPE_CONST, {.i64=4}, 0, 0, DEC, "dtv_fec" },
    { "4_5", "4/5", 0, AV_OPT_TYPE_CONST, {.i64=5}, 0, 0, DEC, "dtv_fec" },
    { "5_6", "5/6", 0, AV_OPT_TYPE_CONST, {.i64=6}, 0, 0, DEC, "dtv_fec" },
    { "5_11", "5/11", 0, AV_OPT_TYPE_CONST, {.i64=7}, 0, 0, DEC, "dtv_fec" },
    { "7_8", "7/8", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, DEC, "dtv_fec" },
    { "1_4", "1/4", 0, AV_OPT_TYPE_CONST, {.i64=9}, 0, 0, DEC, "dtv_fec" },
    { "1_3", "1/3", 0, AV_OPT_TYPE_CONST, {.i64=10}, 0, 0, DEC, "dtv_fec" },
    { "2_5", "2/5", 0, AV_OPT_TYPE_CONST, {.i64=11}, 0, 0, DEC, "dtv_fec" },
    { "6_7", "6/7", 0, AV_OPT_TYPE_CONST, {.i64=12}, 0, 0, DEC, "dtv_fec" },
    { "8_9", "8/9", 0, AV_OPT_TYPE_CONST, {.i64=13}, 0, 0, DEC, "dtv_fec" },
    { "9_10", "9/10", 0, AV_OPT_TYPE_CONST, {.i64=14}, 0, 0, DEC, "dtv_fec" },
    { "dtv_sr", "set symbol rate (symbol/sec)", OFFSET(dtv_sr), AV_OPT_TYPE_INT, {.i64 = 0}, 0, INT_MAX, DEC},
    { "dvbs_polar", "set DVB-S polarisation", OFFSET(dvbs_polar), AV_OPT_TYPE_INT, {.i64 = 0}, -1, BDA_POLARISATION_MAX, DEC , "dvbs_polar"},
    { "not_set", "Not Set", 0, AV_OPT_TYPE_CONST, {.i64=-1}, 0, 0, DEC, "dvbs_polar" },
    { "not_def", "Not Defined", 0, AV_OPT_TYPE_CONST, {.i64=0}, 0, 0, DEC, "dvbs_polar" },
    { "h", "Horizontal", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, DEC, "dvbs_polar" },
    { "v", "Vertical", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, DEC, "dvbs_polar" },
    { "l", "Left circular", 0, AV_OPT_TYPE_CONST, {.i64=3}, 0, 0, DEC, "dvbs_polar" },
    { "r", "Right circular", 0, AV_OPT_TYPE_CONST, {.i64=4}, 0, 0, DEC, "dvbs_polar" },
