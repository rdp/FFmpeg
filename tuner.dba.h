...
DECLARE_INTERFACE_(IComponentTypes,IDispatch)
{
    ...
    STDMETHOD_(HRESULT,put_Item)(THIS_ VARIANT Index,IComponentType *ppComponentType) PURE;
...
#define IComponentTypes_put_Item(This,Index,ppComponentType) (This)->lpVtbl->put_Item(This,Index,ppComponentType)
